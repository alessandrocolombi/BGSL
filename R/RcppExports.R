...
#' @export
Compute_Quantiles <- function(file_name, p, n, stored_iterG = 0L, stored_iter = 0L, Beta = FALSE, Mu = FALSE, TauEps = FALSE, Precision = FALSE, prec_elem = 0L, lower_qtl = 0.05, upper_qtl = 0.95) {
...
#' @export
Compute_PosteriorMeans <- function(file_name, p, n, stored_iterG = 0L, stored_iter = 0L, Beta = FALSE, Mu = FALSE, TauEps = FALSE, Precision = FALSE, prec_elem = 0L) {
...
#' @export
Extract_Chain <- function(file_name, variable, stored_iter, p, n = 0L, index1 = 1L, index2 = 1L, prec_elem = 0L) {
    .Call(`_BGSL_Extract_Chain`, file_name, variable, stored_iter, p, n, index1, index2, prec_elem)
}
